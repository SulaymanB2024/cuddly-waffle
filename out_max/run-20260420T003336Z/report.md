...
## Audit overview
- Run ID: `3c174164-cb26-4fb2-adad-387bab3dda2b`
- Status: `no_field_data`
- Started: `2026-04-20T00:33:36.578420+00:00`
- Completed: `2026-04-20T00:42:56.848770+00:00`
- Run profile: `deep`
- Site type: `general`
...
- Pages with eligible Google features (raw or rendered): 24
- Pages with recognized/supporting schema: 55
- Pages with constrained/deprecated schema: 22
...
- render_diff: 115.03s
- update_pages: 0.20s
- issues_scores_performance: 317.24s
- export_csv: 0.07s

## Crawl heartbeat summary
- Heartbeat events recorded: 1
- Last heartbeat: pages=50 queue=7 errors=0 elapsed_s=112.39
...
- psi: attempts=40 http_attempts=91 retries=51 wait_s=37.57 timeouts=0 success=0 no_data=5 failed_http=35 skipped_missing_key=0
...
- BING_PREVIEW_CONTROLS_RESTRICTIVE: 0 (sample: none)
...
- Verification status counts: automated=344
- Certainty state counts: Probable=164, Unverified=2, Verified=178
- Confidence bands: high=179, low=164, medium=1
- Reach distribution: single_page=7, sitewide=326, template_cluster=11
- Average priority score: 15.00
- Lowest-confidence issues queue:
  - STATIC_SHELL_CANONICAL_REUSED_ACROSS_ROUTES @ https://void-agency.com/ (confidence=55, status=automated)
  - STATIC_SHELL_HREFLANG_REUSED_ACROSS_ROUTES @ https://void-agency.com/ (confidence=55, status=automated)
  - RAW_ONLY_MISSING_H1 @ https://void-agency.com/ (confidence=55, status=automated)
  - RAW_ONLY_THIN_CONTENT @ https://void-agency.com/ (confidence=55, status=automated)
  - RAW_ONLY_LOW_INTERNAL_LINKS @ https://void-agency.com/ (confidence=55, status=automated)
  - RAW_ONLY_MISSING_H1 @ https://www.void-agency.com/ (confidence=55, status=automated)
  - RAW_ONLY_THIN_CONTENT @ https://www.void-agency.com/ (confidence=55, status=automated)
  - RAW_ONLY_LOW_INTERNAL_LINKS @ https://www.void-agency.com/ (confidence=55, status=automated)
  - RAW_ONLY_MISSING_H1 @ https://void-agency.com/auto-body (confidence=55, status=automated)
  - RAW_ONLY_THIN_CONTENT @ https://void-agency.com/auto-body (confidence=55, status=automated)
- Highest-priority issues queue:
  ...
  - CANONICAL_SELF_MISMATCH @ https://void-agency.com/ (priority=38, certainty=Verified, reach=sitewide)
  - REDIRECT_TO_ERROR @ https://void-agency.com/sitemap.xml.gz (priority=38, certainty=Verified, reach=single_page)
  - CANONICAL_SELF_MISMATCH @ https://www.void-agency.com/ (priority=38, certainty=Verified, reach=sitewide)
  - REDIRECT_TO_ERROR @ https://void-agency.com/sitemap_index.xml (priority=38, certainty=Verified, reach=single_page)
  - MULTIPLE_CANONICAL_TAGS @ https://void-agency.com/ (priority=34, certainty=Verified, reach=template_cluster)
  - DUPLICATE_CANONICAL_TAGS @ https://void-agency.com/ (priority=34, certainty=Verified, reach=template_cluster)
  - MULTIPLE_CANONICAL_TAGS @ https://www.void-agency.com/ (priority=34, certainty=Verified, reach=template_cluster)

## Score model diagnostics
- Average quality score: 91.45
- Average risk score: 36.21
- Average measurement coverage: 89.28
- Performance unknown pages (score=-1): 58

## Measurement coverage taxonomy
- Status mix: no_field_data=2, provider_error=18, skipped=38
- Error-family mix: http=18, no_fcp=2, none=38
...
- DUPLICATE_CANONICAL_TAGS: 4
- MULTIPLE_CANONICAL_TAGS: 4
- CANONICAL_CONFLICT_RAW_VS_RENDERED: 0
- CANONICAL_SELF_MISMATCH: 55
- STATIC_SHELL_CANONICAL_REUSED_ACROSS_ROUTES: 1
- STATIC_SHELL_HREFLANG_REUSED_ACROSS_ROUTES: 1
- CLUSTER_CANONICAL_COLLISION: 1
- HOST_DUPLICATION_CLUSTER: 0
...
- Money pages (priority queue): pages=2 issues=20 (critical=0 high=3 medium=9 low=2)
- Utility/taxonomy/template pages (hygiene backlog): pages=0 issues=0 (critical=0 high=0 medium=0 low=0)
- Other content pages: pages=53 issues=324 (critical=0 high=2 medium=166 low=0)
- Run-level/global issues: issues=0 (critical=0 high=0 medium=0 low=0)

## Top issue codes by track
- money: CANONICAL_MISMATCH=2, CANONICAL_SELF_MISMATCH=2, MULTIPLE_CANONICAL_TAGS=2, DUPLICATE_CANONICAL_TAGS=2, RAW_ONLY_MISSING_H1=2
- utility/taxonomy/template: none
- other content: CANONICAL_MISMATCH=53, CANONICAL_SELF_MISMATCH=53, HREFLANG_RECIPROCITY_MISSING=53, RAW_ONLY_MISSING_H1=53, RAW_ONLY_LOW_INTERNAL_LINKS=53
...
- Duplicate titles (effective): 50
- Duplicate descriptions (effective): 55
- Exact duplicate content clusters: 24
- Pages in exact duplicate clusters: 51
- Raw duplicate title clusters (diagnostic): 1
- Raw duplicate description clusters (diagnostic): 1
...
## Run notes
- offsite commoncrawl: disabled; run profile: deep; site type: general; scoring profile: general; crawl persona: id=googlebot_smartphone robots_token=Googlebot meta_scope=googlebot robots_mode=google_exact; crawl retries: retries=1 base_backoff=0.25s max_backoff=4.00s max_total_wait=12.00s respect_retry_after=1; crawl user-agent: persona default; internal host policy: strict mode=all_subdomains hosts=void-agency.com, www.void-agency.com; crawl discovery policy: mode=browser_first render_frontier=1; crawl workers: workers=1 queue_weights=high:3,normal:2,low:1; fresh output dir: out_max/run-20260420T003336Z; runtime versions: extractor=2.0.0 schema_rules=1.0.0 scoring=1.1.0; cache invalidation: extractor_version_changed=0 schema_rule_version_changed=0 scoring_version_changed=0; robots fetch: state=redirect_scope_mismatch bucket=2xx status=200 hops=1; sitemap status: status=skipped_disabled rows=0; crawl planner: discovered=28 seed_urls=28 known_sitemap_urls=25 prioritized_changed_urls=0; crawl policy coverage: crawl_normally=58; crawl discovery telemetry: dedupe_skipped=481, enqueued_total=58, enqueued_via_render_link=30, render_frontier_checks=58, render_frontier_failures=0, render_frontier_successes=58, scope_skipped=0; crawl incremental: discovered=58 fetched=58 reused_from_cache=0 not_modified=0 reparsed=0 rerendered=58; governance summary: googlebot_blocked=0 bingbot_blocked=0 oai_searchbot_blocked=0 google_extended_blocked=0 gptbot_blocked=0 oai_adsbot_blocked=0; canonical clusters: clusters=4 multi_member=1 alias_pages=55; raw duplicate diagnostics: title_clusters=1 description_clusters=1; sitemap intelligence: sitemap_urls=25 discovered_pages=56 not_crawled=0 scope_violations=0; provider targets: https://void-agency.com/ | https://www.void-agency.com/ | https://void-agency.com/insights | https://void-agency.com/insights/case-study | https://void-agency.com/insights/data-maturity; provider scheduler: psi_workers=4 rate_limit=4.00/s burst=4; psi status: success=0 no_data=5 failed_http=35 skipped_missing_key=0; psi no_data: no_data: https://void-agency.com/ [mobile] missing lighthouse categories (retries=2, waited=1.63s) | no_data: https://void-agency.com/ [desktop] missing lighthouse categories (retries=2, waited=1.63s) | no_data: https://www.void-agency.com/ [mobile] missing lighthouse categories (retries=2, waited=1.77s) | no_data: https://www.void-agency.com/ [desktop] missing lighthouse categories (retries=1, waited=0.58s) | no_data: https://void-agency.com/insights/data-maturity [desktop] missing lighthouse categories (retries=1, waited=0.55s); psi errors: failed_http: https://void-agency.com/insights [mobile] Lighthouse returned error: NO_FCP. The page did not paint any content. Please ensure you keep the browser window in the foreground during the load and try again. (NO_FCP) (retries=0, waited=0.00s) | failed_http: https://void-agency.com/insights [desktop] Lighthouse returned error: NO_FCP. The page did not paint any content. Please ensure you keep the browser window in the foreground during the load and try again. (NO_FCP) (retries=1, waited=0.59s) | failed_http: https://void-agency.com/insights/case-study [mobile] Lighthouse returned error: NO_FCP. The page did not paint any content. Please ensure you keep the browser window in the foreground during the load and try again. (NO_FCP) (retries=1, waited=0.59s) | failed_http: https://void-agency.com/insights/case-study [desktop] Lighthouse returned error: NO_FCP. The page did not paint any content. Please ensure you keep the browser window in the foreground during the load and try again. (NO_FCP) (retries=2, waited=1.67s) | failed_http: https://void-agency.com/insights/data-maturity [mobile] Lighthouse returned error: NO_FCP. The page did not paint any content. Please ensure you keep the browser window in the foreground during the load and try again. (NO_FCP) (retries=2, waited=1.77s); crux status: success=0 no_data=20 failed_http=0 skipped_missing_key=0; lighthouse skipped: disabled; psi telemetry: attempts=40 http_attempts=91 retries=51 wait_s=37.57 timeouts=0; crux telemetry: attempts=40 http_attempts=40 retries=0 wait_s=0.00 timeouts=0; gsc skipped: disabled; stage timing: robots=0.49s, sitemaps=0.21s, sitemap_status=0.00s, plan_crawl=0.00s, crawl=126.97s, classify=0.01s, render_diff=115.03s, update_pages=0.20s, issues_scores_performance=317.24s, export_csv=0.07s
